...
public:
  ...
  //young
  std::vector<std::pair<const MCSymbol *, const MCSymbol *> > Patchs;
...
public:
  ...
  /// if appropriate.
  //  young add flag for first machine basic block in the function
  virtual void EmitBasicBlockStart(const MachineBasicBlock &MBB, bool FirstMBB) const;
